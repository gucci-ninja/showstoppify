...
// Module
exports.push([module.i, "\np[data-v-6fb8108a] {\n  font-size: 2em;\n  text-align: center;\n}\n", "",{"version":3,"sources":["/home/suhavi/Documents/OpenSource/TheShoppies/app/javascript/app/javascript/app.vue"],"names":[],"mappings":";AA2CA;EACA,cAAA;EACA,kBAAA;AACA","file":"app.vue","sourcesContent":["<template>\n  <div id=\"app\">\n    <p>{{ message }}</p>\n    <p>{{ getName() }}</p>\n  </div>\n</template>\n\n<script>\nimport axios from 'utils/apiClient';\n\nexport default {\n  data: function () {\n    return {\n      message: \"SHoopie!\",\n      name: '',\n    }\n  },\n  mounted: () => {\n    // const vm = this;\n\n    // axios.get('/landing/test')\n    //   .then(function(res) {\n    //     vm.name = res.name;\n    //     console.log(res.name)\n      \n    //     // console.log(res.data);\n    //   });\n  },\n  methods: {\n    getName: () => {\n      const vm = this;\n\n      axios.get('/landing/test')\n        .then(function(xhr) {\n          vm.name = xhr.data.name;\n\n        });\n    }\n  },\n}\n</script>\n\n<style scoped>\np {\n  font-size: 2em;\n  text-align: center;\n}\n</style>\n"]}]);
// Exports
...
/******/ });
//# sourceMappingURL=application-d32ce24ddbb98b6bd913.js.map