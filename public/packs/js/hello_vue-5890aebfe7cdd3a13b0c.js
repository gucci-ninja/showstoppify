...
// Module
exports.push([module.i, "\np[data-v-6fb8108a] {\n  font-size: 2em;\n  text-align: center;\n}\n", "",{"version":3,"sources":["/home/suhavi/Documents/OpenSource/TheShoppies/app/javascript/app/javascript/app.vue"],"names":[],"mappings":";AAwJA;EACA,cAAA;EACA,kBAAA;AACA","file":"app.vue","sourcesContent":["<template>\n  <div id=\"app\">\n    <p>{{ message }}</p>\n    <v-form>\n      <v-container>\n        <v-row>\n          <v-col\n            cols=\"12\"\n            sm=\"6\"\n            md=\"3\"\n          >\n            <v-text-field\n              label=\"Regular\"\n            ></v-text-field>\n          </v-col>\n\n          <v-col\n            cols=\"12\"\n            sm=\"6\"\n            md=\"3\"\n          >\n            <v-text-field\n              label=\"Regular\"\n              placeholder=\"Placeholder\"\n            ></v-text-field>\n          </v-col>\n\n          <v-col\n            cols=\"12\"\n            sm=\"6\"\n            md=\"3\"\n          >\n            <v-text-field\n              label=\"Solo\"\n              solo\n            ></v-text-field>\n          </v-col>\n\n          <v-col\n            cols=\"12\"\n            sm=\"6\"\n            md=\"3\"\n          >\n            <v-text-field\n              label=\"Solo\"\n              placeholder=\"Placeholder\"\n              solo\n            ></v-text-field>\n          </v-col>\n\n          <v-col\n            cols=\"12\"\n            sm=\"6\"\n            md=\"3\"\n          >\n            <v-text-field\n              label=\"Filled\"\n              filled\n            ></v-text-field>\n          </v-col>\n\n          <v-col\n            cols=\"12\"\n            sm=\"6\"\n            md=\"3\"\n          >\n            <v-text-field\n              label=\"Filled\"\n              placeholder=\"Placeholder\"\n              filled\n            ></v-text-field>\n          </v-col>\n\n          <v-col\n            cols=\"12\"\n            sm=\"6\"\n            md=\"3\"\n          >\n            <v-text-field\n              label=\"Outlined\"\n              outlined\n            ></v-text-field>\n          </v-col>\n\n          <v-col\n            cols=\"12\"\n            sm=\"6\"\n            md=\"3\"\n          >\n          <v-icon aria-hidden=\"false\">\n            mdi-account\n          </v-icon>\n    <v-btn\n      class=\"mx-2\"\n      fab\n      dark\n      large\n      color=\"purple\"\n    >\n      <v-icon dark>\n        mdi-android\n      </v-icon>\n    </v-btn>\n          </v-col>\n        </v-row>\n      </v-container>\n    </v-form>\n      <Movie/>\n  </div>\n\n</template>\n\n<script>\nimport axios from 'utils/apiClient';\nimport Movie from 'components/Movie';\n\nexport default {\n  components: {\n    Movie,\n  },\n  data: function () {\n    return {\n      message: \"SHoopie!\",\n      name: '',\n    }\n  },\n  mounted: () => {\n    // const vm = this;\n\n    // axios.get('/landing/test')\n    //   .then(function(res) {\n    //     vm.name = res.name;\n    //     console.log(res.name)\n      \n    //     // console.log(res.data);\n    //   });\n  },\n  methods: {\n    getName: function() {\n\n      axios.get('/landing/test')\n        .then((xhr) => {\n          this.name = xhr.data.name;\n\n        });\n        return this.name;\n    }\n  },\n}\n</script>\n\n<style scoped>\np {\n  font-size: 2em;\n  text-align: center;\n}\n</style>\n"]}]);
// Exports
...
/******/ });
//# sourceMappingURL=hello_vue-5890aebfe7cdd3a13b0c.js.map