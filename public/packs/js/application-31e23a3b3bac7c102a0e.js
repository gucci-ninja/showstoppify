...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    var vm = _this;
    utils_apiClient__WEBPACK_IMPORTED_MODULE_0__["default"].get('/landing/test').then(function (res) {
      vm.name = res.name;
      console.log(res.name); // console.log(res.data);
    });
  },
  methods: {
    getName: function getName() {
      return 'hi'; // const vm = this;
      // axios.get('/landing')
      //   .then( (res) => {
      //     vm.name = res.data;
...
// Module
exports.push([module.i, "\np[data-v-6fb8108a] {\n  font-size: 2em;\n  text-align: center;\n}\n", "",{"version":3,"sources":["/home/suhavi/Documents/OpenSource/TheShoppies/app/javascript/app/javascript/app.vue"],"names":[],"mappings":";AA4CA;EACA,cAAA;EACA,kBAAA;AACA","file":"app.vue","sourcesContent":["<template>\n  <div id=\"app\">\n    <p>{{ message }}</p>\n    <p>{{ name }}</p>\n  </div>\n</template>\n\n<script>\nimport axios from 'utils/apiClient';\n\nexport default {\n  data: function () {\n    return {\n      message: \"SHoopie!\",\n      name: '',\n    }\n  },\n  mounted: () => {\n    const vm = this;\n\n    axios.get('/landing/test')\n      .then(function(res) {\n        vm.name = res.name;\n        console.log(res.name)\n      \n        // console.log(res.data);\n      });\n  },\n  methods: {\n    getName: () => {\n      return 'hi'\n      // const vm = this;\n\n      // axios.get('/landing')\n      //   .then( (res) => {\n      //     vm.name = res.data;\n      //     console.log(res.data);\n      //   });\n    }\n  },\n}\n</script>\n\n<style scoped>\np {\n  font-size: 2em;\n  text-align: center;\n}\n</style>\n"]}]);
// Exports
...
/******/ });
//# sourceMappingURL=application-31e23a3b3bac7c102a0e.js.map