...
// Module
exports.push([module.i, "\np[data-v-6fb8108a] {\n  font-size: 2em;\n  text-align: center;\n}\n", "",{"version":3,"sources":["/home/suhavi/Documents/OpenSource/TheShoppies/app/javascript/app/javascript/app.vue"],"names":[],"mappings":";AAoCA;EACA,cAAA;EACA,kBAAA;AACA","file":"app.vue","sourcesContent":["<template>\n  <div id=\"app\">\n    <p>{{ message }}</p>\n    <p>{{ name }}</p>\n  </div>\n</template>\n\n<script>\nimport axios from 'utils/apiClient';\n\nexport default {\n  data: function () {\n    return {\n      message: \"SHoopie!\",\n      name: '',\n    }\n  },\n  mounted: () => {\n    this.getName();\n  },\n  methods: {\n    getName: () => {\n      return 'hi'\n      // const vm = this;\n\n      // axios.get('/landing')\n      //   .then( (res) => {\n      //     vm.name = res.data;\n      //     console.log(res.data);\n      //   });\n    }\n  },\n}\n</script>\n\n<style scoped>\np {\n  font-size: 2em;\n  text-align: center;\n}\n</style>\n"]}]);
// Exports
...
/******/ });
//# sourceMappingURL=application-b964b0d3fc99c7d6b1aa.js.map