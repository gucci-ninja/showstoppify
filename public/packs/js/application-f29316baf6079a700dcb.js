...
"use strict";
__webpack_require__.r(__webpack_exports__);
!(function webpackMissingModule() { var e = new Error("Cannot find module 'utils/request'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
var _this = undefined;
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getName: function getName() {
      var vm = this;
      !(function webpackMissingModule() { var e = new Error("Cannot find module 'utils/request'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).get('/landing').then(function (res) {
        vm.name = res.data;
...
// Module
exports.push([module.i, "\np[data-v-6fb8108a] {\n  font-size: 2em;\n  text-align: center;\n}\n", "",{"version":3,"sources":["/home/suhavi/Documents/OpenSource/TheShoppies/app/javascript/app/javascript/app.vue"],"names":[],"mappings":";AAmCA;EACA,cAAA;EACA,kBAAA;AACA","file":"app.vue","sourcesContent":["<template>\n  <div id=\"app\">\n    <p>{{ message }}</p>\n    <p>{{ name }}</p>\n  </div>\n</template>\n\n<script>\nimport axios from 'utils/request'\n\nexport default {\n  data: function () {\n    return {\n      message: \"SHoopie!\",\n      name: '',\n    }\n  },\n  methods: {\n    getName() {\n      const vm = this;\n\n      axios.get('/landing')\n        .then( (res) => {\n          vm.name = res.data;\n          console.log(res.data);\n        });\n    }\n  },\n  mounted: () => {\n    this.getName();\n  }\n}\n</script>\n\n<style scoped>\np {\n  font-size: 2em;\n  text-align: center;\n}\n</style>\n"]}]);
// Exports
...
/******/ });
//# sourceMappingURL=application-f29316baf6079a700dcb.js.map